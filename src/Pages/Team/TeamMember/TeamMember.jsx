...
const contactInfo = [
    ...
    },
    {
        ...
        value: 'Goheer Town Street No 2. Bahawalpur',
                ...
                <div className="w-full md:w-1/2 md:ps-4 lg:ps-5 mt-8 md:mt-0">
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            Sikandar Hayat is the founder and CEO of Coding First, a leading software house known for delivering innovative and customized digital solutions. With over 5 years of experience in the tech industry, Sikandar has a strong background in software engineering and a passion for turning ideas into impactful software. Under their leadership, Coding First has built a reputation for quality, client satisfaction, and cutting-edge technology. Sikandar is dedicated to fostering a culture of excellence and continuous learning within the team.
                            </p>
                        </div>
