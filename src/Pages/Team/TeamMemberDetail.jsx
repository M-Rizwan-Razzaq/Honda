    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-4 md:px-16 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className='w-full lg:w-[40%] shadow-2xl border-2 border-[#C32735] p-6 md:p-8'>
          ...
          <p className="mt-4">
            <Link to={member.profileLink} className="text-[#C32735] hover:underline">
              View Profile
            </Link>
          </p>
          <div className="mt-4 flex space-x-4">
            ...
            <Link to={member.socialLinks.FaGithub} target="_blank" rel="noopener noreferrer">
              <FaGithub className='text-black hover:text-[#C32735] w-5 h-5'/>
            </Link>
